package org.saipal.oascore.admistr.service;
...
import org.saipal.oascore.admistr.model.Organization;
...
//			return Messenger.getMessenger().error();
	...
	public ResponseEntity<Map<String, Object>> edit(String id) {
		...
		String sql = "select id as orgidint,code,name, adm_level, adm_id,parent from "
				+ table + " where id=?";
	...
	public ResponseEntity<Map<String, Object>> getAdmin(String id) {
		...
		if(id.equals("4")) {
			 sql = "select vcid as id,nameen as name,namenp from admin_local_level_structure where disabled=? and approved=?";
		}
