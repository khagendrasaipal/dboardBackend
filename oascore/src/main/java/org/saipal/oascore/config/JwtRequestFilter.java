package org.saipal.oascore.config;
...
import org.saipal.oascore.service.AuthService;
import org.saipal.oascore.service.SystemConfigService;
import org.saipal.oascore.service.UserService;
import org.saipal.oascore.util.FmisUtil;
import org.saipal.oascore.util.JwtUtil;
...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	List<String> excludeResource = Arrays.asList("/favicon.ico", "/sw.js", "/error", "/assets/", "/backup/", "/css/",
			...
			"/keystore/", "/menuimage/", "/ng-auth/", "/qrcodes/", "/ribbon/", "/sjs/", "/wrtc-signal","calender","/sign-in","/test/**","/test/dashboard","/test/web","/Emblem_of_Nepal_2020.svg","/getDashboard");
